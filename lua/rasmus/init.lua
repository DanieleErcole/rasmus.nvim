...
local set_groups = function()
    local groups = {
        ...
        Visual = { fg = c.fg, bg = c.gray05 },
        VisualNOS = { fg = c.fg, bg = c.gray05 },
        ...
        TSMethod = { fg = c.green, bold = cfg.function_style.bold, italic = cfg.function_style.italic },              -- For method calls and definitions.
